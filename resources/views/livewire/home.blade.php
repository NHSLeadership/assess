            ...
            <div class="nhsuk-grid-column-three-quarters">
                ...
                <div class="nhsuk-action-link">
                    <a class="nhsuk-action-link__link" href="{{ route('assessment-home') }}">
                        ...
                        <span class="nhsuk-action-link__text">Login</span>
                    </a>
                </div>

                <p>Alternatively, you can <a href="https://profile.leadershipacademy.nhs.uk/register">register</a> and create a new Academy profile to start your assessment.</p>
