...
<header class="nhsuk-header nhsuk-header--organisation" data-module="nhsuk-header" role="banner" data-nhsuk-header-init="">
    <div class="nhsuk-header__container nhsuk-width-container">
        <div class="nhsuk-header__service">
            <a class="nhsuk-header__service-logo" href="{{ route('home') }}" aria-label="Home page">
                ...
                <span class="nhsuk-header__organisation-name">{{ Str::after(config('app.organisation'), 'NHS ') }}</span>
                <span class="nhsuk-header__service-name">{{ config('app.name') }}</span>
            </a>
        </div>
