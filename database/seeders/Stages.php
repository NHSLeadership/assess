...
class Stages extends Seeder
{
    ...
    public function run(): void
    {
        \App\Models\Stage::factory()->createManyQuietly([
            ['name' => 'Fundamentals', 'description' => 'This stage outlines the essential competencies expected of every manager and leader who is accountable for operational delivery and the outcomes of others, regardless of their level of seniority or specific role. It also supports employees preparing for their first steps into a management or leadership position by setting out the minimum standard and expectations for those managing or leading in healthcare settings.'],
