...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $questions = [
            ...
            ['node_id' => 11, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Take accountability for my actions', 'text' => 'Taking responsibility for actions and using feedback and self-reflection to help improve how we act.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 12, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Be visible, transparent and present', 'text' => 'Helping colleagues and patients to feel included - sharing updates, listening to their views and interacting openly and respectfully.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 13, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Manage with civility and compassion', 'text' => 'Listening and responding to colleagues and patients’ concerns with interest, care, and professionalism.', 'required' => true, 'order' => 0, 'active' => true],

            ['node_id' => 14, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Build engagement', 'text' => 'Helping people to feel involved, recognising their strengths, encouraging teamwork, celebrating success and sharing what we’ve learned.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 15, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Make sure people feel safe in the workplace', 'text' => 'Making sure that everyone acts safely, feels safe to speak up, and can identify risks and safety training needs.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 16, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Manage challenges', 'text' => 'Supporting colleagues in challenging situations - encouraging them to focus on what they can control during change or crisis.', 'required' => true, 'order' => 0, 'active' => true],
