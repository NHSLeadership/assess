...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $questions = [
            ...
            //['node_id' => 2, 'scale_id' => null, 'response_type' => Question::TYPE_TEXTAREA, 'title' => 'Additional notes', 'text' => 'Additional notes or comments regarding "Balancing safety, productivity and wellbeing"', 'required' => 0, 'order' => 3, 'active' => true],
