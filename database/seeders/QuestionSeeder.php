...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $questions = [
            ...
            ['node_id' => 3, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Develop personal safety and wellbeing strategies', 'text' => 'I manage my health and wellbeing. I set realistic goals and seek support when I need it.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 3, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Commit to continuing professional development', 'text' => 'I continuously build skills and knowledge. I encourage participation in peer learning and development, sharing good practice and seeking feedback.', 'required' => true, 'order' => 0, 'active' => true],
            //['node_id' => 2, 'scale_id' => null, 'response_type' => Question::TYPE_FREE_TEXT, 'title' => 'Additional notes', 'text' => 'Additional notes or comments regarding "Balancing safety, productivity and wellbeing"', 'required' => 0, 'order' => 3, 'active' => true],

            ['node_id' => 4, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Communicate with clarity and purpose', 'text' => 'I communicate clearly, concisely, and respectfully to avoid misunderstandings and ensure effective information sharing.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 4, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Encourage open dialogue and feedback', 'text' => 'I encourage open dialogue and feedback, to foster a supportive environment, by ensuring colleagues and patients feel safe to speak up, and consciously listening to others, sharing concerns and challenge upwards.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 4, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Influence, negotiate and manage upwards', 'text' => 'I recognise the value of influencing others, including using storytelling, expertise and lived experiences and knowing how to manage upwards, to effectively gain support and achieve desired outcomes.', 'required' => true, 'order' => 0, 'active' => true],
