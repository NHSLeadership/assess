...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $questions = [
            ...
            ['node_id' => 3, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Develop personal health and wellbeing strategies', 'text' => 'Managing own health and wellbeing, setting realistic goals and seeking support when needed.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 3, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Commit to continuing professional development', 'text' => 'Continuously building skills and knowledge, encouraging peer learning and development, sharing good practice and seeking feedback.', 'required' => true, 'order' => 0, 'active' => true],
            ...
            ['node_id' => 7, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Encourage open dialogue and feedback', 'text' => 'Helping colleagues and patients to speak up, listening and following up on what they say.', 'required' => true, 'order' => 0, 'active' => true],
            ['node_id' => 7, 'scale_id' => 1, 'response_type' => ResponseType::TYPE_SCALE, 'title' => 'Influence, negotiate and manage upwards', 'text' => 'Making sure people’s voices are heard and concerns are escalated, negotiating on their behalf if necessary.', 'required' => true, 'order' => 0, 'active' => true],
